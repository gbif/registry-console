    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        if (!this.props.organization) {
          ...
          updateCollection({ ...this.props.organization, ...values })
...
const WrappedOrganizationForm = Form.create()(withContext(mapContextToProps)(formValidationWrapper(CollectionForm)));
