    ...
    <dl>
      ...
      <PresentationItem label={<FormattedMessage id="featuredImageUrl" defaultMessage="Featured image URL" />}>
        ...
        {collection.featuredImageUrl && <div style={{color: '#aaa', margin: '12px 0'}}>
          ...
          <img alt="" src={`//api.gbif.org/v1/image/unsafe/250x250/${encodeURIComponent(collection.featuredImageUrl)}`} style={{border: '1px solid #888', marginBottom: 12}} />
          <img alt="" src={`//api.gbif.org/v1/image/unsafe/250x100/${encodeURIComponent(collection.featuredImageUrl)}`} style={{border: '1px solid #888'}} />
        </div>}
      </PresentationItem>
