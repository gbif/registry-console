export const prettifyCountry = name => {
  switch (name) {
    case 'AD':
      return 'Andorra';
    case 'AE':
    ...
    case 'QO':
      return 'Oceania';
    case 'ZZ':
      return 'Unknown or invalid (used internally at GBIF for int. orgs)';
    default:
      return name;
  }
};

export const prettifyUserType = name => {
  switch (name) {
    case 'TECHNICAL_POINT_OF_CONTACT':
      return 'Technical point of contact';
    case 'ADMINISTRATIVE_POINT_OF_CONTACT':
      return 'Administrative point of contact';
    ...
    case 'CUSTODIAN_STEWARD':
      return 'Custodian steward';
    case 'DISTRIBUTOR':
      return 'Distributor';
    case 'EDITOR':
      return 'Editor';
    ...
    case 'TEMPORARY_HEAD_OF_DELEGATION':
      return 'Temporary head of delegation';
    case 'TEMPORARY_DELEGATE':
      return 'Temporary delegate';
    case 'REGIONAL_NODE_REPRESENTATIVE':
      return 'Regional node representative';
    case 'NODE_STAFF':
      return 'Node staff';
